...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('peringatan/ajax_list')?>",
            "type": "POST", "data":function(data){
                ...
                data.id_jenis_peringatan = $('select[name=id_jenis_peringatan2]').val();
    ...
    //datepicker
    $('#tgl_peringatan,#tgl_peringatan2,#tgl_mulai,#tgl_selesai').datepicker({
        autoclose: true,
        format: "dd-mm-yyyy",
        todayHighlight: true,
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown)
                {
                    alert('Error get option pegawai from ajax');
                }
            });
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
				...
				<div class="form-group fg-verifikator">
						<label class="control-label col-md-3" for="id_verifikator">Verifikator</label>
						<div class="col-md-9">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
					<input placeholder="DD-MM-YYYY" type="text" name="tgl_peringatan" id="tgl_peringatan" class="form-control" id="datepicker" />
					<span class="help-block"></span>
					</div>
				</div>
