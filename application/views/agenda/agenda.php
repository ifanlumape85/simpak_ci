      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
        		<button class="btn btn-success btn-flat btn-sm" onclick="add_agenda()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
        		<button class="btn btn-default btn-flat btn-sm" onclick="reload_agenda_table()"><i class="glyphicon glyphicon-refresh"></i> Muat Ulang</button>
            ...
            <div class="panel-body">
                <form id="form-filter" class="form-horizontal">
		          ...
		          <div class="form-group">
                        <label for="jenis agenda " class="col-sm-2 control-label">Jenis Agenda </label>
                        <div class="col-sm-4">
                            <?php echo $form_jenis_agenda2; ?>
                        </div>
                    </div>
