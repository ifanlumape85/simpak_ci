      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
        		<button class="btn btn-success btn-flat btn-sm" onclick="add_kegiatan_tahunan()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
                <?php if ($this->session->userdata('user_level_id') == 1) { ?> 
        		<button class="btn btn-default btn-flat btn-sm" onclick="reload_kegiatan_tahunan_table()"><i class="glyphicon glyphicon-refresh"></i> Muat Ulang</button>
