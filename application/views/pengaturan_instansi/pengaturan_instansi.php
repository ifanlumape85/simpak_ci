      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
        		<button class="btn btn-success btn-flat btn-sm" onclick="add_pengaturan_instansi()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
        		<button class="btn btn-default btn-flat btn-sm" onclick="reload_pengaturan_instansi_table()"><i class="glyphicon glyphicon-refresh"></i> Muat Ulang</button>
