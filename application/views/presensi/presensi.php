        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
        		...
        		<button class="btn btn-success btn-flat btn-sm btn_add" onclick="add_presensi()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
        		<button class="btn btn-default btn-flat btn-sm" onclick="reload_presensi_table()"><i class="glyphicon glyphicon-refresh"></i> Muat Ulang</button>
            ...
            <div class="panel-body">
                <form id="form-filter" class="form-horizontal">
		          ...
		          <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="instansi" class="col-sm-2 control-label">Jenis Presensi</label>
                        <div class="col-sm-4">
