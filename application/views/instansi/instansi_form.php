...
$(document).ready(function() {
    ...
    $('#btn-filter').click(function(){ //button filter event click
        reload_instansi_table();  //just reload table
    });
...
function edit_instansi(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('instansi/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
         $('[name="id"]').val(data.id_instansi);
...
function reload_instansi_table()
{
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('instansi/ajax_add')?>";
    } else {
        url = "<?php echo site_url('instansi/ajax_update')?>";
    }
...
function delete_instansi(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('instansi/ajax_delete')?>/"+id,
            type: "POST",
    ...
    if(list_id.length > 0)
    {
        if(confirm('Are you sure delete this '+list_id.length+' data?'))
        {
            $.ajax({
                ...
                url: "<?php echo site_url('instansi/ajax_bulk_delete')?>",
                dataType: "JSON",
                success: function(data)
                {
                    if(data.status)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Instansi Form</h3>
            </div>
            <div class="modal-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                       <label class="control-label col-md-3" for="nama_instansi">Nama Instansi</label>
                       <div class="col-md-9">
                        <input placeholder="Nama Instansi" type="text" name="nama_instansi" class="form-control" />		
