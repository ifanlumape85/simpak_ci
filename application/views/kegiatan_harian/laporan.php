            ...
            <div class="panel-body">
                <form id="form-filter" class="form-horizontal">
                    ...
                    <div class="form-group fg-tahun2">
                        <label for="tahun" class="col-sm-2 control-label">Tgl Awal</label>
                        <div class="col-sm-4">
                            <input type="text" name="tgl_awal" id="datepicker1" class="form-control" />
                        </div>
                    </div>

                    <div class="form-group fg-tahun2">
                        <label for="tahun" class="col-sm-2 control-label">Tgl Akhir</label>
                        <div class="col-sm-4">
                            <input type="text" name="tgl_akhir" id="datepicker2" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <button type="button" id="btn-cetak" class="btn btn-primary btn-flat btn-sm"><i class="fa fa-filter"></i> Cetak</button>
