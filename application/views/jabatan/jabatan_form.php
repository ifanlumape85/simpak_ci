...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            ...
            "type": "POST", "data":function(data){
                ...
                data.id_jabatan = $('#id_jabatan').val();
            }
        },
    ...
    $('#btn-filter').click(function(){ //button filter event click
        reload_jabatan_table();  //just reload table
    });
    ...
    if(list_id.length > 0)
    {
        if(confirm('Are you sure delete this '+list_id.length+' data?'))
        {
            $.ajax({
                ...
                url: "<?php echo site_url('jabatan/ajax_bulk_delete')?>",
                dataType: "JSON",
                success: function(data)
                {
                    if(data.status)
            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                       <label class="control-label col-md-3" for="nama_jabatan">Jabatan</label>
                       <div class="col-md-9">
                        <input placeholder="Jabatan" type="text" name="nama_jabatan" class="form-control" />		
                        <span class="help-block"></span>
                        </div>
                    </div>

                    <div class="form-group">
                       <label class="control-label col-md-3" for="urutan">Urutan</label>
                       <div class="col-md-9">
                        <input placeholder="Urutan" type="text" name="urutan" class="form-control" />        
                        <span class="help-block"></span>
                        </div>
                    </div>
                </div>
