...
$(document).ready(function() {
    ...
    $('#btn-filter').click(function(){ //button filter event click
        reload_golongan_table();  //just reload table
    });
...
function reload_golongan_table()
{
    ...
    if(list_id.length > 0)
    {
        if(confirm('Are you sure delete this '+list_id.length+' data?'))
        {
            $.ajax({
                ...
                url: "<?php echo site_url('golongan/ajax_bulk_delete')?>",
                dataType: "JSON",
                success: function(data)
                {
                    if(data.status)
...
<div class="modal fade" id="modal_form" role="dialog">
            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                       <label class="control-label col-md-3" for="nama_golongan">Nama Golongan</label>
                       <div class="col-md-9">
                        <input placeholder="Nama Golongan" type="text" name="nama_golongan" class="form-control" />		
    ...
    <div class="modal-footer">
        <button type="button" id="btnSave" onclick="save()" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Simpan</button>
